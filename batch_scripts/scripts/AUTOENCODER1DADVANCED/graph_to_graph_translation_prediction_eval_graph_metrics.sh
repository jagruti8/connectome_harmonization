...
#SBATCH --job-name autoencoder1Dadveval     # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/AUTOENCODER1DADVANCED/GRAPHMETRICS/prediction/metrics/local_efficiency/ #(CHANGE DIRECTORY TO THIS ONE)
...
MAINDIR="AUTOENCODER1DADVANCED"

# Set the path to the parameter combinations file
PARAM_FILE="/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/parameters/$MAINDIR/parameters_combinations_prediction_graph_metrics.txt"
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_autoencoder1Dadvanced_harmonization_graph_metrics.py $ALL_PARAMS # (PATH to the python file you want to execute)
