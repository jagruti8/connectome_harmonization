...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/AUTOENCODER1DADVANCED/training/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/vector_vector_translation_data_augmentation_advanced_2.py $ALL_PARAMS # (PATH to the python file you want to execute)
