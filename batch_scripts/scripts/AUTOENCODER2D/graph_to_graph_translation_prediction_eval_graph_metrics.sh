...
#SBATCH --job-name ae2deval     # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/AUTOENCODER2D/GRAPHMETRICS/prediction/metrics/local_efficiency/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_autoencoder2D_harmonization_graph_metrics.py $ALL_PARAMS # (PATH to the python file you want to execute)
