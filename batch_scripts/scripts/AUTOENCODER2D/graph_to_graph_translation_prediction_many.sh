...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/image_image_translation_data_augmentation_autoencoder_2d_prediction_main.py # (PATH to the python file you want to execute)
