...
#SBATCH --job-name linear_harmonization      # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/LINEAR/ #(CHANGE DIRECTORY TO THIS ONE)
...
EXTRA_PARAMS="--maindir $MAINDIR --ckdir $CKDIR --train_set $trainSet --val_set $valSet --test_set $testSet"
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/linear_mixed_travelling_harmonization.py $ALL_PARAMS # (PATH to the python file you want to execute)
