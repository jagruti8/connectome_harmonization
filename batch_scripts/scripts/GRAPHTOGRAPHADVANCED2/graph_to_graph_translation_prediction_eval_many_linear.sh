...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/GRAPHTOGRAPHADVANCED2/prediction/linear/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_graph_harmonization_linear.py # (PATH to the python file you want to execute)
