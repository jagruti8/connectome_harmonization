...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/graph_evaluation_all_metrics_main.py $ALL_PARAMS # (PATH to the python file you want to execute)
