...
#SBATCH --job-name graph2graphadv2eval     # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/GRAPHTOGRAPHADVANCED2/GRAPHMETRICS/prediction/metrics/local_efficiency/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_graph_harmonization_graph_metrics.py $ALL_PARAMS # (PATH to the python file you want to execute)
