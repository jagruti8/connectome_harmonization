...
#SBATCH --array=0-3      # Replace with the number of lines in your parameter file - 1
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/GRAPHTOGRAPHADVANCED2/GRAPHMETRICS/prediction/ #(CHANGE DIRECTORY TO THIS ONE)
...
PARAM_FILE="/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/parameters/$MAINDIR/GRAPHMETRICS/parameters_combinations_1.txt"
...
PARAMS=$(sed -n "$((SLURM_ARRAY_TASK_ID+13))p" $PARAM_FILE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/calculate_graph_metrics_augmented_matrices.py $ALL_PARAMS # (PATH to the python file you want to execute)
