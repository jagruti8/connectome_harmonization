...
#SBATCH --job-name graph2graphadv2prediction      # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/GRAPHTOGRAPHADVANCED2/prediction/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/graph_graph_translation_data_augmentation_advanced_prediction_main.py # (PATH to the python file you want to execute)
