...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_test_retest_linear.py $ALL_PARAMS # (PATH to the python file you want to execute)
