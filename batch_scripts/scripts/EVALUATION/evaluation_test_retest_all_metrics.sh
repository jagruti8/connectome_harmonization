...
#SBATCH --job-name evalAllMetrics      # Job name
#SBATCH --account rad
...
#SBATCH --chdir=/data/hagmann_group/harmonization/graph_harmonization_final/batch_scripts/log_files/EVALUATION/prediction/ #(CHANGE DIRECTORY TO THIS ONE)
...
python /data/hagmann_group/harmonization/graph_harmonization_final/src/evaluation_test_retest_all_metrics.py  # (PATH to the python file you want to execute)
