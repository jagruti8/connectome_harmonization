...
print("autoencoder2D_evaluation_all_metrics_main.py starting")
...
from autoencoder2D_evaluation_all_metrics import autoencoder2D_evaluation_function
...
def main():
    ...
    autoencoder2D_evaluation_function(output_path, parameter_file_combination_path,
