...
import numpy as np
import torch
from graph_graph_translation_data_augmentation_advanced_prediction_all import run_prediction

print("graph_graph_translation_data_augmentation_advanced_prediction_main.py starting")
...
if __name__ == "__main__":
    ...
    parameter_combination_file_numbers = np.array([1,2])
