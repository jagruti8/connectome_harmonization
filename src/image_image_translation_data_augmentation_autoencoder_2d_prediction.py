...
print("image_image_translation_data_augmentation_autoencoder_2d_prediction.py starting")
...
from utils.data import load_graphs_dict, graph_matrix_vector, create_directory
...
def main():
    ...
    n_features, n_outputs = test_dataset.input_tensors[0].shape[0], config.output
    ...
    #train_subject_IDs, train_input_images, train_target_images, train_predicted_images, train_reversed_features, \
    #train_label_site, train_output_site, train_mae, train_accuracy, train_entropy = predict(model, device, train_dataloader, config)
    val_subject_IDs, val_input_images, val_target_images, val_predicted_images, val_reversed_features, \
    val_label_site, val_output_site, val_mae, val_accuracy, val_entropy = predict(model, device, val_dataloader, config)
    test_subject_IDs, test_input_images, test_target_images, test_predicted_images, test_reversed_features, \
